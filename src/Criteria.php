...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'key_wrapper_id', 'target_kms1_key_id', 'target_kms2_key_id', 'scheduled_at', 'started_at', 'finished_at', 'status', 'attempts', 'last_error', 'created_at' ];
    ...
    protected function joinable(): array
    {
        ...
        return [ 'key_wrappers' => 'j0', 'kms_keys' => 'j1' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\RewrapJobs\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\RewrapJobs\Definitions::softDeleteColumn();
