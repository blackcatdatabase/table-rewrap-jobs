...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'rewrap_jobs'; }
    public static function contractView(): string { return 'vw_rewrap_jobs'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'key_wrapper_id', 'target_kms1_key_id', 'target_kms2_key_id', 'scheduled_at', 'started_at', 'finished_at', 'status', 'attempts', 'last_error', 'created_at' ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'key_wrapper_id', 'target_kms1_key_id', 'target_kms2_key_id', 'attempts' ]; }
