...
use BlackCat\Database\Packages\RewrapJobs\Repository\RewrapJobRepository;
...
{
    private RewrapJobRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new RewrapJobRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RewrapJobs\Dto\RewrapJobDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\RewrapJobs\Dto\RewrapJobDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RewrapJobs\Dto\RewrapJobDto|null
    {
