...
namespace BlackCat\Database\Packages\RewrapJobs\Mapper;

use BlackCat\Database\Packages\RewrapJobs\Dto\RewrapJobDto;
use BlackCat\Database\Packages\RewrapJobs\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO RewrapJobDto:
...
final class RewrapJobDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'key_wrapper_id', 'target_kms1_key_id', 'target_kms2_key_id', 'attempts' ];
    /** @var string[] */
     ...
     * @return RewrapJobDto
     */
    public static function fromRow(array $row): RewrapJobDto
    {
        /** @var RewrapJobDto */
    ...
    public static function fromRowOrNull(?array $row): ?RewrapJobDto
    {
     ...
     *
     * @param RewrapJobDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(RewrapJobDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(RewrapJobDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(RewrapJobDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,RewrapJobDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,RewrapJobDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(RewrapJobDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,RewrapJobDto>
     */
