...
final class RewrapJobsModule implements ModuleInterface
{
    public function name(): string { return 'table-rewrap_jobs'; }
    public function table(): string { return 'rewrap_jobs'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-key_wrappers', 'table-kms_keys' ]; }

    public static function contractView(): string { return 'vw_rewrap_jobs'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_rewrap_kw', 'idx_rewrap_status_sched' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_rewrap_kw', 'fk_rewrap_tk1', 'fk_rewrap_tk2' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_rewrap_kw', 'idx_rewrap_status_sched' ],
            'foreignKeys' => [ 'fk_rewrap_kw', 'fk_rewrap_tk1', 'fk_rewrap_tk2' ],
        ];
    }
}
