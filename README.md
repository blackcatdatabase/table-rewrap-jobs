...
> Lineage: 2 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 4 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\rewrap-jobs](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\rewrap-jobs) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package rewrap-jobs -Apply
